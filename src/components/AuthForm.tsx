    ...
    try {
      if (isLogin) {
        ...
        toast({
          ...
          description: "Zkontrolujte svůj e-mail pro ověření účtu.",
        });
      }
    } catch (error: any) {
      toast({
        title: isLogin ? "Chyba přihlášení" : "Chyba registrace",
    ...
    <div className="w-full max-w-sm space-y-6">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" className="w-full gap-2" disabled={loading}>
          ...
          {loading ? "Zpracování..." : isLogin ? "Přihlásit se" : "Registrovat"}
        </Button>
      </form>
